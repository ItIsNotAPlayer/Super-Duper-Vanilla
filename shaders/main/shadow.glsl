...
/// -------------------------------- /// Vertex Shader /// -------------------------------- ///
        ...
        void main(){
            ...
            waterNoiseUv = vertexShdWorldPosXZ * waterTileSizeInv;
                ...
                vertexShdEyePlayerPos = getTerrainWave(vertexShdEyePlayerPos, vertexShdWorldPosXZ, at_midBlock.y * 0.015625, mc_Entity.x, min(gl_MultiTexCoord1.y * 0.00416667, 1.0), vertexFrameTime);
            #endif
            ...
            #if defined TERRAIN_ANIMATION || defined WATER_ANIMATION || defined PHYSICS_OCEAN || defined WORLD_CURVATURE
